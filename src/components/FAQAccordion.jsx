      ...
      <div className="container" style={{ maxWidth: '900px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>
            Everything you need to know about Growixa's email deliverability, B2B lead search, and
            AI safety engine.
          </p>
        </div>
          ...
          {faqs.map((faq, idx) => {
            ...
            return (
              <div
                ...
                style={{ borderColor: isOpen ? 'var(--accent-emerald)' : 'var(--border-color)' }}
              >
                ...
                {isOpen && <div className="accordion-body animate-fade-in">{faq.a}</div>}
              </div>
            );
          })}
        </div>
