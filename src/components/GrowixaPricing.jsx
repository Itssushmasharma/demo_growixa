...
export default function GrowixaPricing({ openBookingModal }) {
  ...
  const emailSteps = [
    { label: '5k', count: 5000, priceUSD: 13.5, priceINR: 562.5 },
    { label: '10k', count: 10000, priceUSD: 21.0, priceINR: 925.0 },
    { label: '15k', count: 15000, priceUSD: 29.0, priceINR: 1210.5 },
    { label: '20k', count: 20000, priceUSD: 37.0, priceINR: 1650.0 },
    { label: '30k', count: 30000, priceUSD: 49.0, priceINR: 2150.0 },
    { label: '50k', count: 50000, priceUSD: 69.0, priceINR: 3100.0 },
    { label: '100k+', count: 100000, priceUSD: 119.0, priceINR: 5400.0 },
  ];
  ...
  const brandingCost = currency === 'USD' ? 8.0 : 675.0;
  const rawPrice = basePrices[currency][activePlanTab];
  const totalPrice =
    typeof rawPrice === 'number' ? rawPrice + (removeBranding ? brandingCost : 0) : 'Custom';
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '820px', margin: '0 auto 3rem auto' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>
            Pay for the emails you send, not the size of your contact list. Unused capacity rolls
            over smoothly.
          </p>
          ...
          >
            ...
            >
              ...
              <button
                ...
                style={{
                  background: currency === 'INR' ? '#0B996E' : 'transparent',
                  color: currency === 'INR' ? '#FFFFFF' : '#6B7280',
                  border: 'none',
              ...
              <button
                ...
                style={{
                  background: currency === 'USD' ? '#0B996E' : 'transparent',
                  color: currency === 'USD' ? '#FFFFFF' : '#6B7280',
                  border: 'none',
                  padding: '0.2rem 0.5rem',
                  borderRadius: '4px',
                  cursor: 'pointer',
            ...
            return (
              ...
              >
                ...
                <button
                  onClick={openBookingModal}
                  className={
                    p.name === 'Enterprise' || p.name === 'Professional'
                      ? 'btn-secondary'
                      : 'btn-primary'
                  }
                  style={{
        ...
        <div
          ...
          style={{
            padding: '2.5rem',
            borderRadius: '20px',
            border: '1px solid rgba(11, 153, 110, 0.3)',
            marginBottom: '5rem',
            background: '#FFFFFF',
              ...
              >
                {emailSteps.map((s, idx) => (
                  <span
                    key={idx}
                    style={{
                      color: idx === emailVolumeIndex ? '#0B996E' : '#6B7280',
                      fontWeight: idx === emailVolumeIndex ? 800 : 400,
                    }}
                  >
                    {s.label}
                  </span>
              ...
              >
                <div>
                  <div style={{ fontSize: '0.9rem', fontWeight: 700, color: '#111827' }}>
                    Remove Growixa branding
                  </div>
                  <div style={{ fontSize: '0.775rem', color: '#6B7280' }}>
                    +{formatPrice(brandingCost)} per month
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <span style={{ color: '#0B996E', fontWeight: 700 }}>
                    {currentStep.count.toLocaleString()} / mo
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                {removeBranding && (
                  <div
                    style={{ display: 'flex', justifyContent: 'space-between', color: '#0B996E' }}
                  >
        ...
        <div id="checklist" style={{ marginTop: '5rem' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={{ color: '#6B7280', fontSize: '1rem' }}>
              Compare features included across Starter, Standard, Professional, and Enterprise
              tiers.
            </p>
          </div>
          ...
          >
            ...
            <div
              className="glass-card"
              style={{ padding: '1.75rem', borderRadius: '16px', background: '#FFFFFF' }}
            >
              <h4
                style={{
                  fontSize: '1.15rem',
