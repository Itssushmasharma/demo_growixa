  ...
  return (
    <header
      style={{
        ...
        right: 0,
        zIndex: 1000,
        background: scrolled ? 'var(--bg-glass)' : 'var(--bg-hero)',
        ...
        >
          ...
          >
            ...
            {activeDropdown === 'platform' && (
              <div
                className="mega-menu-panel animate-fade-in"
                style={{ minWidth: '760px', left: '100px' }}
              >
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '2rem' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.15rem' }}>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '0.775rem', color: 'var(--text-muted)' }}>
                            Boost conversions with automated multichannel customer journeys.
                          </div>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '0.775rem', color: 'var(--text-muted)' }}>
                            Send real-time email, SMS, & WhatsApp messages via Postmark SMTP.
                          </div>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '0.775rem', color: 'var(--text-muted)' }}>
                            Accelerate revenue with custom pipelines and lead enrichment.
                          </div>
                        </div>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            Growixa Data Platform (CDP)
                          </div>
                          <div style={{ fontSize: '0.775rem', color: 'var(--text-muted)' }}>
                            Unify and activate customer data for dynamic rule segmentation.
                          </div>
                        </div>
                      </a>
                    </div>
                  ...
                  {/* Channels Column */}
                  <div
                    style={{ paddingLeft: '1.5rem', borderLeft: '1px solid var(--border-color)' }}
                  >
                    <h5
                      style={{
                        fontSize: '0.75rem',
                    ...
                    >
                      ...
                      >
                        <Mail size={16} color="#0B996E" /> Email
                      </div>
                      <div
                        style={{
                          display: 'flex',
                      ...
                      >
                        <MessageSquare size={16} color="#0B996E" /> SMS
                      </div>
                      <div
                        style={{
                          display: 'flex',
                      ...
                      >
                        <Send size={16} color="#0B996E" /> WhatsApp
                      </div>
                      <div
                        style={{
                          display: 'flex',
                      ...
                      >
                        <Globe size={16} color="#0B996E" /> Web Push
                      </div>
                      <div
                        style={{
                          display: 'flex',
                      ...
                      >
                        <Bot size={16} color="#0B996E" /> Live Chat
                      </div>
                      <div
                        style={{
                          display: 'flex',
                      ...
                      >
                        <Phone size={16} color="#0B996E" /> Phone Dials
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.15rem' }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.775rem', color: 'var(--text-muted)' }}>
                        Run campaigns and manage contacts easily.
                      </div>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.775rem', color: 'var(--text-muted)' }}>
                        Custom solutions, dedicated onboarding, and enterprise security.
                      </div>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.775rem', color: 'var(--text-muted)' }}>
                        Build, extend, and integrate with open API and SDKs.
                      </div>
                    </div>
                  </a>
                </div>
          ...
          >
            ...
            {activeDropdown === 'resources' && (
              <div
                className="mega-menu-panel animate-fade-in"
                style={{ minWidth: '650px', left: '-50px' }}
              >
