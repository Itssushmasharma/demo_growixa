      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 3.5rem auto' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>
            See how Growixa consolidates marketing automation, B2B lead enrichment, and AI agents
            into one transparent platform.
          </p>
        </div>
        ...
        <div
          ...
          style={{ padding: '2rem', borderRadius: 'var(--radius-lg)', overflowX: 'auto' }}
        >
