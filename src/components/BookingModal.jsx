        ...
        {!submitted ? (
          <div>
            <div style={{ marginBottom: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.8rem', fontWeight: 700, color: 'var(--accent-emerald)', textTransform: 'uppercase' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '0.25rem' }}>
                Instant access to high-deliverability email pipelines, dynamic CRM segmentation, and AI brand voice tools.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.15rem' }}>
              ...
              <div>
                ...
                <select
                  ...
                  className="form-input"
                >
                  <option value="Full SaaS Growth Stack">Full SaaS Growth Stack (Email, Social, CRM, AI)</option>
                  <option value="Postmark Email Pipeline">Postmark & Custom SMTP Email Pipeline</option>
                  ...
                  <option value="GEO & AEO Intelligence">Answer Engine Optimization (AEO/GEO)</option>
                </select>
              </div>
              ...
              <button
                ...
                style={{ width: '100%', justifyContent: 'center', padding: '0.85rem 1.5rem', marginTop: '0.5rem', fontSize: '1rem' }}
              >
          ...
          <div style={{ textAlign: 'center', padding: '2rem 0' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', marginBottom: '1.5rem', lineHeight: 1.6 }}>
              We have generated your instant platform workspace credentials for <strong>{formData.companyName}</strong>. Check your inbox at <span style={{ color: 'var(--accent-emerald)' }}>{formData.workEmail}</span> for your verification token link.
            </p>
