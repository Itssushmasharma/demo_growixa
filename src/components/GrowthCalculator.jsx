      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 3.5rem auto' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>
            Estimate how high-deliverability email pipelines, dynamic CRM segmentation, and AI brand copy accelerate your monthly recurring revenue.
          </p>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              ...
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  <label style={{ fontSize: '0.9rem', fontWeight: 600, color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <DollarSign size={16} color="var(--accent-violet)" /> Avg Customer Lifetime Value (LTV):
                  </label>
                  <span style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, color: 'var(--accent-violet)' }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontSize: 'clamp(2.5rem, 4vw, 3.25rem)', fontWeight: 800, color: '#34D399', margin: '0.5rem 0' }}>
                  ${projectedMonthlyRevenue.toLocaleString()} <span style={{ fontSize: '1rem', color: 'var(--text-muted)' }}>/mo</span>
                </div>
              ...
              <div style={{
                ...
                <div>
                  <span style={{ color: 'var(--text-muted)', display: 'block' }}>Est. Monthly Conversions</span>
                  <strong style={{ fontSize: '1.2rem', color: 'var(--text-primary)' }}>{estimatedConversions} Sales</strong>
                </div>
                <div>
                  <span style={{ color: 'var(--text-muted)', display: 'block' }}>CAC Reduction</span>
                  <strong style={{ fontSize: '1.2rem', color: 'var(--accent-emerald)' }}>-{cacReductionPercent}% Cost</strong>
                </div>
              </div>
